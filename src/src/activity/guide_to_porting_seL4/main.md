...
4. Building and executing seL4Test can be performed by following the instructions previously provided in the [seL4test](../../first_boot/sel4test.md) and [Bootloader Setup](../../install_and_configure/bootloader_setup.md) sections with the build commands modified appropriately to target the newly added platform.
